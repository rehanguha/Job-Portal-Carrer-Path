<%@ Page Language="C#" MasterPageFile="~/Recruiter/RecruiterMasterPage.master" AutoEventWireup="true" CodeFile="frmSearchJobSeekerByLocation.aspx.cs" Inherits="Recruiter_SearchJobSeeker_frmSearchJobSeekerByLocation" Title="Untitled Page" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td align="center" colspan="2" style="height: 24px">
                <strong>Select Location To Search JobSeeker:</strong><asp:DropDownList ID="ddlLocation"
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    PageSize="5" Width="755px" Font-Size="Small">
