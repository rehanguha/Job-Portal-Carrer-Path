<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMenuMasterPage.master" AutoEventWireup="true" CodeFile="frmModifyJobSeekerBackgroundDetail.aspx.cs" Inherits="Admin_ViewReports_Jobseeker_frmModifyJobSeekerBackgroundDetail" Title="Untitled Page" %>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" style="width: 674px">
        ...
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" style="font-size: 12pt; color: #006600; font-weight: bold;">
                <strong style="font-weight: bold; color: #800080">Highest Degree Atained:</strong>&nbsp;</td>
        ...
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff">
                <strong style="font-weight: bold; font-size: 12pt; color: #800080">Year Of Passing:</strong></td>
        ...
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff">
                <strong style="font-weight: bold; font-size: 12pt; color: #800080">Percentage:</strong></td>
            <td align="left" colspan="1" style="font-size: 12pt; width: 33px; color: #ffffff">
                <span style="color: #ff0000; font-weight: bold;">*</span></td>
            <td align="left" colspan="2">
        ...
        <tr style="font-size: 12pt; color: #ffcc00">
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff">
                <strong style="font-weight: bold; font-size: 12pt; color: #800080">University:</strong></td>
            <td align="left" colspan="1" style="font-size: 12pt; width: 33px; color: #ffffff">
                <span style="color: #ff0000; font-weight: bold;">*</span></td>
            <td align="left" colspan="2">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="lstUniversity"
                ...
                <asp:TextBox ID="txtUniversity" runat="server" Width="142px"></asp:TextBox><br />
                <strong><span style="color: #ffffff"></span></strong>
            </td>
        </tr>
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff">
                <strong style="font-weight: bold; font-size: 12pt; color: #800080">Country:</strong></td>
            <td align="left" colspan="1" style="font-size: 12pt; width: 33px; color: #ffffff">
                <span style="color: #ff0000; font-weight: bold;">*</span></td>
            <td align="left" colspan="2">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlCountryName"
                    ErrorMessage="*" ValidationGroup="g1" Width="1px"></asp:RequiredFieldValidator></td>
        </tr>
        <tr style="font-size: 12pt">
            <td align="center" colspan="4" style="font-size: 12pt; color: #ffffff">
                &nbsp; &nbsp;
        ...
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff">
                <strong style="font-weight: bold; font-size: 12pt; color: #800080">Technical Experience:</strong></td>
            <td align="left" colspan="1" style="font-size: 12pt; width: 33px; color: #ffffff">
                <span style="color: #ff0000; font-weight: bold;">*</span></td>
            <td align="left" colspan="2">
        ...
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff; height: 22px;">
                <strong style="font-weight: bold; font-size: 12pt; color: #800080">Work Field:</strong></td>
        ...
        <tr style="font-size: 12pt">
            <td align="center" colspan="4" style="font-size: 12pt; color: #ffffff">
                &nbsp;
                <asp:Button ID="btnModify" runat="server" Text="Modify" Width="90px" Font-Bold="True" OnClick="btnModify_Click" ValidationGroup="g1" />
